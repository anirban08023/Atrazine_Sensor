...
plt.ylabel("Angle of Incidence (degrees)", fontsize=14)
plt.xlabel("Limit of Detection (LOD) [µM]", fontsize=14)
plt.title("Sensor LOD Performance by Angle of Incidence", fontsize=16, fontweight='bold')
