...
# --- Customize Plot ---
ax.set_xlabel('No of period', fontsize=16, labelpad=15)
ax.set_ylabel('Log10(Concentration (µM))', fontsize=16, labelpad=15)
ax.set_zlabel('Figure of Merit (uM^-1)', fontsize=16, labelpad=15)


# Add a color bar which maps values to colors.
cbar = fig.colorbar(surf, shrink=0.6, aspect=10)
cbar.set_label('Figure of Merit (uM^-1)', fontsize=16)
