...
# --- Load Data ---
csv_filename = 'Defect_PEAK_Tolerance.csv'
try:
...
x = df['Defect Layer Thickness Deviation (%)']
y = df['Concentration (uM)']
z = df['Resonance Deviation (nm)']
...
# --- Customize Plot ---
ax.set_xlabel('Defect Layer Thickness Deviation (%)', fontsize=16, labelpad=15)
ax.set_ylabel('Log10(Concentration (µM))', fontsize=16, labelpad=15)
ax.set_zlabel('Resonance Deviation (nm)', fontsize=16, labelpad=15)
ax.tick_params(axis='z', pad=10)


# Add a color bar which maps values to colors.
cbar = fig.colorbar(surf, shrink=0.6, aspect=10)
cbar.set_label('Resonance Deviation (nm)', fontsize=16)
